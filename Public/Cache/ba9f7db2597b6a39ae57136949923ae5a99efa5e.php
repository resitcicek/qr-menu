                        ...
                        <div class="card-body">
                            ...
                            <form id="update-category" class="forms-sample update-category" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputName1">İçerik İsmi</label>
                                    <input type="text" name="title" class="form-control" id="firstname" placeholder="İsim" value="<?php echo e($data['title']); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName1">İçerik Açıklaması (İçindekiler)</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" class="form-control" value="<?php echo e($data['price']); ?>" id="lastname">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select type="text" name="categoryid" class="form-control">
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if($data['categoryid'] == $cat->id): ?> selected <?php endif; ?> value="<?php echo e($cat->id); ?>"><?php echo e($cat->title); ?></option>
...
<?php echo $__env->make('Admin/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Public\Views/Admin/edit-food.blade.php ENDPATH**/ ?>