                        ...
                        <div class="card-body">
                            ...
                            <form id="update-category" class="forms-sample update-category" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" class="form-control" value="{{$data['price']}}" id="lastname">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName1">Kategori</label>
                                    <select type="text" name="categoryid" class="form-control">
                                        @foreach ($categories as $cat)
                                            <option @if($data['categoryid'] == $cat->id) selected @endif value="{{$cat->id}}">{{$cat->title}}</option>
                                        @endforeach
